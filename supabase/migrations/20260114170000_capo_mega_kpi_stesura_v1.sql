...
-- Canon rules:
--   - stesura_giorno = stesura + ripresa
--   - fascettatura esclusa dal calcolo posa
--   - la curva parte dal primo rapportino del capo (D0)
--   - offset iniziale dedotto da INCA: cavi già in 'P' al momento D0 (scope INCA)
-- ============================================================================
