 ...
 *   stato_inca,           // SITUAZIONE CAVO brut
  ...
  return new Promise((resolve, reject) => {
    ...
    reader.onload = (e) => {
      try {
        ...
        // 2) Construire le mapping colonne → champ
        const colIndex = {
          marca: null,
          codice: null,
          livello: null,
        ...
        for (let i = headerRowIndex + 1; i < rows.length; i++) {
          ...
          if (!marca) {
            // Ligne complètement vide → on peut ignorer
            continue;
          }
          ...
          // Nettoyage SITUAZIONE : garder seulement les valeurs acceptées par le check
