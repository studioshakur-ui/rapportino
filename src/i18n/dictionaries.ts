...
const coreDict = {
  it: {
    ...
    // Dashboard Direzione
    DIR_KICKER: "Direzione · CNCS / CORE",
    ...
    DIR_REASONS_TITLE: "Driver",
    DIR_INSIGHTS_TITLE: "Azioni consigliate",
    DIR_SCORE: "Punteggio",
    DIR_SCORE_FORMULA: "Formula: media degli indici produttività per operatore.",
    DIR_SCORE_INCLUSION: "Inclusione: operatori con indice calcolabile (previsto e realizzato presenti).",
    DIR_SCORE_STATS: "Operatori inclusi: {i}/{t} · Mediana: {m} · Dispersione P10–P90: {p10}–{p90}",
    DIR_RELIABILITY: "Affidabilità",
    DIR_RELIABILITY_HIGH: "Alta",
    DIR_RELIABILITY_MEDIUM: "Media",
    DIR_RELIABILITY_LOW: "Bassa",
    DIR_DATA_INCOMPLETE: "Dati incompleti: interpretazione cauta",
    DIR_REASON_PROD_FMT: "Indice prod: {v} (target {t}=parità, Δ {d})",
    DIR_REASON_INCA_FMT: "INCA coverage: {p} (realizzati {r} / baseline {b} m)",
    DIR_REASON_RITARDI_FMT: "Ritardi capi: {v} · deadline 08:30 (J+1)",
    DIR_RITARDI_NA: "Non disponibile (piani DAY FROZEN assenti)",
    DIR_INSIGHT_PROD_NA: "Indice prod non disponibile: verificare i dati di base.",
    DIR_INSIGHT_PROD_LOW: "Indice prod sotto target: analizzare scostamenti per squadra/commessa.",
    DIR_INSIGHT_PROD_OK: "Indice prod in linea: preservare ritmo e fattori di stabilità.",
    DIR_INSIGHT_INCA_NA: "INCA non disponibile: verificare import e filtri COSTR/Commessa.",
    DIR_INSIGHT_INCA_LOW: "Coverage INCA basso: completare baseline o audit dis.",
    DIR_INSIGHT_INCA_OK: "Coverage INCA stabile: monitorare variazioni di baseline.",
    DIR_INSIGHT_RITARDI: "Ritardi presenti: rivedere planning DAY FROZEN e deadline 08:30.",
    DIR_INSIGHT_RITARDI_OK: "Ritardi sotto controllo: mantenere disciplina di consegna.",
    DIR_TIMELINE_TITLE: "Timeline",
    DIR_TIMELINE_SUB: "Bar: Ritardi capi · Linea: Rapportini",
    DIR_TIMELINE_BAR: "Ritardi capi",
    ...
    KPI_VS_PREV: "vs prev",
    KPI_METRI: "metri",
    KPI_DEADLINE: "deadline 08:30 (J+1)",
    DIR_PROD_FORMULA: "Σrealizzato / Σprevisto_alloc (MT)",
  ...
  fr: {
    ...
    DIR_REASONS_TITLE: "Facteurs",
    DIR_INSIGHTS_TITLE: "Actions recommandées",
    DIR_SCORE: "Score",
    DIR_SCORE_FORMULA: "Formule : moyenne des indices de productivité par opérateur.",
    DIR_SCORE_INCLUSION: "Inclusion : opérateurs avec indice calculable (prévu et réalisé présents).",
    DIR_SCORE_STATS: "Opérateurs inclus : {i}/{t} · Médiane : {m} · Dispersion P10–P90 : {p10}–{p90}",
    DIR_RELIABILITY: "Fiabilité",
    DIR_RELIABILITY_HIGH: "Haute",
    DIR_RELIABILITY_MEDIUM: "Moyenne",
    DIR_RELIABILITY_LOW: "Basse",
    DIR_DATA_INCOMPLETE: "Données incomplètes : interprétation prudente",
    DIR_REASON_PROD_FMT: "Indice prod : {v} (cible {t}=parité, Δ {d})",
    DIR_REASON_INCA_FMT: "Couverture INCA : {p} (réalisé {r} / baseline {b} m)",
    DIR_REASON_RITARDI_FMT: "Retards capi : {v} · deadline 08:30 (J+1)",
    DIR_RITARDI_NA: "Non disponible (plannings DAY FROZEN absents)",
    DIR_INSIGHT_PROD_NA: "Indice prod indisponible : vérifier les données de base.",
    DIR_INSIGHT_PROD_LOW: "Indice prod sous la cible : analyser les écarts par équipe/commessa.",
    DIR_INSIGHT_PROD_OK: "Indice prod conforme : maintenir le rythme et la stabilité.",
    DIR_INSIGHT_INCA_NA: "INCA indisponible : vérifier import et filtres COSTR/Commessa.",
    DIR_INSIGHT_INCA_LOW: "Couverture INCA faible : compléter baseline ou audit dis.",
    DIR_INSIGHT_INCA_OK: "Couverture INCA stable : surveiller les variations de baseline.",
    DIR_INSIGHT_RITARDI: "Retards présents : revoir planning DAY FROZEN et deadline 08:30.",
    DIR_INSIGHT_RITARDI_OK: "Retards maîtrisés : maintenir la discipline de remise.",
    DIR_TIMELINE_TITLE: "Timeline",
    ...
    KPI_METRI: "mètres",
    KPI_DEADLINE: "deadline 08:30 (J+1)",
    DIR_PROD_FORMULA: "Σréalisé / Σprévu_alloc (MT)",
  ...
  en: {
    ...
    DIR_RELIABILITY_LOW: "Low",
    DIR_DATA_INCOMPLETE: "Data incomplete: interpret with caution",
    DIR_REASON_PROD_FMT: "Prod index: {v} (target {t}=parity, Δ {d})",
    DIR_REASON_INCA_FMT: "INCA coverage: {p} (realized {r} / baseline {b} m)",
    DIR_REASON_RITARDI_FMT: "Capo delays: {v} · deadline 08:30 (J+1)",
    DIR_RITARDI_NA: "Not available (no DAY FROZEN plans)",
    DIR_INSIGHT_PROD_NA: "Prod index unavailable: verify base data.",
    DIR_INSIGHT_PROD_LOW: "Prod index below target: review gaps by team/commessa.",
    DIR_INSIGHT_PROD_OK: "Prod index on target: keep rhythm and stability factors.",
    DIR_INSIGHT_INCA_NA: "INCA unavailable: verify import and COSTR/Commessa filters.",
    DIR_INSIGHT_INCA_LOW: "INCA coverage low: complete baseline or audit dis.",
    DIR_INSIGHT_INCA_OK: "INCA coverage stable: monitor baseline changes.",
    DIR_INSIGHT_RITARDI: "Delays present: review DAY FROZEN planning and 08:30 deadline.",
    DIR_INSIGHT_RITARDI_OK: "Delays under control: keep delivery discipline.",
    DIR_TIMELINE_TITLE: "Timeline",
    ...
    KPI_METRI: "meters",
    KPI_DEADLINE: "deadline 08:30 (J+1)",
    DIR_PROD_FORMULA: "Σrealized / Σplanned_alloc (MT)",
