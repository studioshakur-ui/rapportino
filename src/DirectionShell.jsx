...
export default function DirectionShell() {
  ...
  const isInPresentation = isActive("/direction/presentazione");
  const isInCapoPresentation = isActive("/direction/presentazione/capo");
      ...
      <div className="flex">
        ...
        <main className="flex-1 px-4 sm:px-6 py-6">
          <div className="max-w-6xl mx-auto space-y-4">
            {isInPresentation && (
              <div className="no-print flex items-center justify-between gap-3 rounded-2xl border border-slate-800 bg-slate-950/20 px-3 py-2">
                <div className="text-[11px] uppercase tracking-[0.22em] text-slate-500">
                  Presentazione
                </div>
                <div className="flex items-center gap-2">
