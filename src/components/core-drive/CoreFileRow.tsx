...
function statoBadge(stato: string | undefined): string {
  const base =
...
export default function CoreFileRow({
  file,
  selected,
  onSelect,
}: {
  ...
  const createdAt = file.created_at ? new Date(file.created_at).toLocaleString() : "—";
